...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference('Leaderboard.count') do
      post leaderboards_url, params: { leaderboard: { Bscore: @leaderboard.Bscore, Cscore: @leaderboard.Cscore, Fscore: @leaderboard.Fscore, Hscore: @leaderboard.Hscore, user_id: @leaderboard.user_id } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { Bscore: @leaderboard.Bscore, Cscore: @leaderboard.Cscore, Fscore: @leaderboard.Fscore, Hscore: @leaderboard.Hscore, user_id: @leaderboard.user_id } }
